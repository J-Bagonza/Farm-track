      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center text-center lg:pr-16">
        ...
        <form className="w-full max-w-lg">
          <div className="flex border rounded-lg overflow-hidden mb-4 h-12">
            ...
            <input type="text" placeholder="Full Name" className="w-full p-3 focus:outline-none text-sm" />
          </div>
          ...
          <div className="flex border rounded-lg overflow-hidden mb-4 h-12">
            ...
            <input type="tel" placeholder="Phone Number" className="w-full p-3 focus:outline-none text-sm" />
          </div>
          ...
          <div className="flex border rounded-lg overflow-hidden mb-4 h-12">
            ...
            <input type="email" placeholder="Email Address" className="w-full p-3 focus:outline-none text-sm" />
          </div>
      ...
      <div className="w-full lg:w-1/2 mt-10 lg:mt-0 flex flex-col items-center">
        ...
        <div className="mt-6 w-full grid grid-cols-1 md:grid-cols-2 gap-4">
          {funFacts.map((fact, index) => (
            <motion.div
              key={index}
              className={`flex items-center p-3 md:p-4 bg-gray-100 rounded-xl shadow-md border-l-4 ${fact.color}`}
